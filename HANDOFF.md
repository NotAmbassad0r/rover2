...
Last updated: 2026-06-13 (HA timeout 5→3s + INFO log; MegaPi battery estimate + DIAG rows; all API calls use apiBase(); camera idle suppressed during tracking; 2-frame warmup skip after camera wake)
